    ...
    <main className={styles.main}>
      ...
      <section className={styles.heroSection}>
        ...
        <p className={styles.heroText}>
          Ми збираємо мініатюрні капсули, які можна тримати в руках, перегортати
          та відчитувати заново — зі шрифтом, що нагадує ручний друк, та запахом
      ...
      <section className={styles.storySection}>
        <div>
          ...
          <p>
            Перший поверх студії — це простір із великими вікнами та м’яким
            теракотовим світлом, де шиті вручну книги лежать поряд із
            культурними артефактами.
          </p>
        </div>
        <div>
          <p className={styles.storyLabel}>Подія тижня</p>
          <p>
            Майстер-клас з каліграфії, де гості створюють свої міні-капсули на
            папері з текстурою грубої льняної нитки. Кожна капсула закривається
            шнуром з бронзовим замком.
          </p>
        </div>
      </section>
      ...
      <section className={styles.ctaSection}>
        ...
        <p>
          Підпишись на нотатки, щоб отримати лист-послання, коли наступна
          капсула буде готова до розпаковки.
        </p>
